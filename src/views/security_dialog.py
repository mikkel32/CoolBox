...
class SecurityDialog(ttk.Frame):
    def __init__(self, master: tk.Tk):
        ...
        self._fw_switch = ttk.Checkbutton(self, text="Enabled", variable=self._fw_var, command=self._on_fw_toggle)
        ...
        self._rt_switch = ttk.Checkbutton(self, text="Enabled", variable=self._rt_var, command=self._on_rt_toggle)
