...
def _load_system_module() -> ModuleType:
    """Return a freshly imported system utilities module."""

    module = importlib.import_module("coolbox.utils.system")
...
_TARGET_MODULE = _load_system_module()
__all__ = _reexport(_TARGET_MODULE)


class _SystemProxy(ModuleType):
    """Mirror attribute updates onto the underlying system module."""
...
if _module_obj is not None:
    _module_obj.__class__ = _SystemProxy


del importlib, ModuleType, _load_system_module, _reexport
