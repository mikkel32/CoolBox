...
from coolbox.utils.display import get_screen_refresh_rate
...
from coolbox.utils.display.color_utils import (
    hex_brightness,
    lighten_color,
    darken_color,
)
from coolbox.utils.display.mouse_listener import get_global_listener

# Import the click overlay early so its heavy dependencies are loaded
# before the first "Kill by Click" invocation.
from ..overlays.click_overlay import ClickOverlay, KILL_BY_CLICK_INTERVAL
